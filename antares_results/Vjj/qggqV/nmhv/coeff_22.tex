...
\begin{my}
$\begin{gathered}
\scriptscriptstyle\frac{1/2⟨3|1+2|4]³[𝟓|𝟓|4⟩⟨4𝟓⟩s_{𝟓}}{⟨23⟩⟨1|2+3|4]⟨2|1+3|4]⟨4|𝟓|4]²s_{123}} +\\
\scriptscriptstyle\frac{1⟨3|1+2|4]³[𝟓|𝟓|4⟩⟨2|1+3|𝟓|𝟓⟩}{⟨23⟩⟨1|2+3|4]⟨2|1+3|4]²⟨4|𝟓|4]s_{123}} \phantom{+}
\end{gathered}$
\end{my}
\end{document}
