...
\begin{my}
$\begin{gathered}
\scriptscriptstyle\frac{⟨12⟩[13](3/2⟨12⟩[13]+3⟨24⟩[34])}{⟨14⟩⟨24⟩⟨1|2+4|1]} +\\
\scriptscriptstyle\frac{-1⟨12⟩²[23][13]}{⟨14⟩²⟨1|2+4|1]} +\\
\scriptscriptstyle\frac{1/2⟨12⟩²[13]²[24]}{⟨14⟩⟨1|2+4|1]²} \phantom{+}
\end{gathered}$
\end{my}
\end{document}
