...
\begin{my}
$\begin{gathered}
\scriptscriptstyle\frac{6⟨23⟩[34]⟨1|2+3|4]}{⟨13⟩²⟨3|1+2|3]} +\\
\scriptscriptstyle\frac{-1[34]⟨2|1+3|4]}{⟨13⟩⟨3|1+2|3]} +\\
\scriptscriptstyle\frac{-1⟨24⟩[34]⟨3|1+2|4]}{⟨13⟩⟨34⟩⟨3|1+2|3]} \phantom{+}
\end{gathered}$
\end{my}
\end{document}
