...
\begin{my}
$\begin{gathered}
\scriptscriptstyle\frac{1⟨14⟩⟨1|𝟓|1]⟨3|2+4|1]⟨4|2-3|1]}{⟨13⟩²⟨23⟩⟨2|3+4|1]s_{234}} +\\
\scriptscriptstyle\frac{2⟨14⟩⟨34⟩⟨1|2+4|1]⟨1|𝟓|1]⟨3|2+4|1]}{⟨13⟩³⟨23⟩⟨2|3+4|1]s_{234}} \phantom{+}
\end{gathered}$
\end{my}
\end{document}
